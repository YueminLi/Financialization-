...
```{r}
p_load('ecm')
xeq <- xtr <- va_df[c('IV_lending_pc', 'IV_gov_exp_pc', 'IV_trade_balance_pc', 'IV_fdi_net_pc','C_REER', 'C_wgdp', 'C_cpi', 'C_wgini')]
...
xeq <- xtr <- nfc_df[c('IV_lending_pc', 'IV_gov_exp_pc', 'IV_trade_balance_pc', 'IV_fdi_net_pc','C_REER', 'C_wgdp', 'C_cpi', 'C_wgini')]
...
xeq <- xtr <- hh_df[c('IV_lending_pc', 'IV_gov_exp_pc', 'IV_trade_balance_pc', 'IV_fdi_net_pc','C_REER', 'C_wgdp', 'C_cpi', 'C_wgini')]
...
#### 3.5 Durbin-Watson Test for autocorrelation

```{r}
library(car)
durbinWatsonTest(m1_lm)
durbinWatsonTest(m2_lm)
durbinWatsonTest(m3_lm)
```
