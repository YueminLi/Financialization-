---
title: 
      Statecraft Contingency or Development Pitfall?
subtitle: 
      Explaining the Rise of Financialization in a Global Perspective
author: 
      - Yuemin Li 
      - Yimang Zhou"
...
p_load(tidyverse, knitr, kableExtra, rmarkdown, ggplot2)
```
...
kable(t1,  "pipe",
      ...
      col.names = rep(c("Variable", "ADF Statistics",
                        "Values added in financial activities", "Nonfinancial corporate debts", "Household debts",
...
kable(t2, "pipe",
      digit = 2, booktabs = T,
      caption = "Phillips-Ouliaris Test for Co-integration", 
      col.names = rep(c("Phillips-Ouliaris demeaned","Values added in financial activities", 
